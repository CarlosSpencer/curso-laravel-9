    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center border-b border-gray-300">
                <a class="bg-orange-300 hover:bg-orange-200 px-3 py-2 rounded-full" href="{{ route('users.edit', $user->id) }}">Editar</a>
            </td>
            <td class="text-center border-b border-gray-300">
                <a  class="bg-green-300 hover:bg-green-200 px-3 py-2 rounded-lg text-center" href="{{ route('users.show', $user->id) }}">Detalhes</a>
            </td>
        </tr>
        @endforeach
    </tbody>
